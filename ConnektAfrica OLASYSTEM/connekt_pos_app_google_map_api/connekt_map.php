...
for ($lcnt = 0; $lcnt < $mrk_cnt; $lcnt++)
{
	...
	echo "var infowindow$lcnt = new google.maps.InfoWindow({
			...
			//mashaka
			if($pos[$lcnt] == 798095664 && $low[$lcnt] > 10000){
			 ...
			 else if($pos[$lcnt] == 798095664 && $low[$lcnt] < 10000){
			...
			if($pos[$lcnt] == 798095523 && $low[$lcnt] > 10000){
			 ...
			 else if($pos[$lcnt] == 798095523 && $low[$lcnt] < 10000){
						 echo "var marker$lcnt = new google.maps.Marker({position: point$lcnt, map: map, icon: 		  		'http://connektafrica.net/img/lb.png'});\n";
			}
			
			// 	IPYANA WILLSON 	798095667
			else 
			if($pos[$lcnt] == 798095667 && $low[$lcnt] > 10000){
			...
			else if($pos[$lcnt] == 798095667 && $low[$lcnt] < 10000){
						 echo "var marker$lcnt = new google.maps.Marker({position: point$lcnt, map: map, icon: 		  		'http://connektafrica.net/img/lb.png'});\n";
			}
			
			// 	DIBWE SAID 	798095666
			else 
			if($pos[$lcnt] == 798095666 && $low[$lcnt] > 10000){
			...
			else if($pos[$lcnt] == 798094990 && $low[$lcnt] < 10000){
						 echo "var marker$lcnt = new google.maps.Marker({position: point$lcnt, map: map, icon: 		  		'http://connektafrica.net/img/lb.png'});\n";
			}
			
			// JAMILAH KINGU 	798093866  	
			else 
			if($pos[$lcnt] == 798093866 && $low[$lcnt] > 10000){
			...
			else if($pos[$lcnt] == 798093866 && $low[$lcnt] < 10000){
						 echo "var marker$lcnt = new google.maps.Marker({position: point$lcnt, map: map, icon: 		  		'http://connektafrica.net/img/lb.png'});\n";
			}
