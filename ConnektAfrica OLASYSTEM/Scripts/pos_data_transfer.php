<?php
echo'<title>Smart to Connekt POS</title>';
...
<div align="center">
  <p class="style1">Data Transfer [POS Transaction History + Selcom & Maxcom] (Smart to Connekt Africa online server) Query Completed Successfully</p>
