<title>All_POS_Trans_OUT</title><?php
...
<div align="center">
  ...
  <p class="style1">Query POS Number Range [0798090000 to 0798099999] == [79809%] + Maxcom and Selcom, Mobistock and Finance (778899)</p>
...
$sql1 = "SELECT a.acct_book_id,
       ...
       and g.cust_id = h.cust_id
       and to_char(a.created_date,'MM/DD/YYYY')  = '$d'
	   and g.acc_nbr  in ('888888888' ,'777777777', '333333333', '778899')
       order by 1,2 asc";
