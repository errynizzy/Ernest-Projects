<title>Get POS Transaction Test</title><?php
...
//fetch from oracle
$sql = "SELECT a.acct_book_id, h.cust_name ORIGIANL_CUSTOMER,
  ...
  FROM acct_book    A,
       ...
       subs         G,
       cust         H
 where to_char(a.created_date,'mm/dd/yyyy') between  '08/13/2014' and '08/26/2014'
   ...
   and b.acc_nbr not like ('798092%')
   and b.acc_nbr not in ('798020036','798700700','798500500','798025102')
   and b.acc_nbr not like ('798100%')
   and g.acc_nbr not like ('798100%')
   and g.acc_nbr not like ('798700700')
   and g.acc_nbr not like ('798500500')
   and g.acc_nbr <> ('798025102')
   and g.acc_nbr not like ('798020%')
...
while ( $row = oci_fetch_assoc($stmt) ) {
 ...
 $DEST_SERVICE_NUMBER = $row['DEST_SERVICE_NUMBER'];
  ...
  $sql = ("INSERT INTO pos_out_test (ACCT_BOOK_ID,TRANSFER_DATE, ORIGIANL_CUSTOMER, ORG_SERVICE_NUMBER, CHARGE, DESTINATION_CUSTOMER, DEST_SERVICE_NUMBER)
