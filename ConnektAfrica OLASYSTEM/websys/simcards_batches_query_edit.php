...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("simcards_batches_query", "inline_edit");
else 
	$templatefile = GetTemplateName("simcards_batches_query", "edit");
...
$savedKeys["ICCID"] = postvalue("editid1");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// key get query
	$keyGetQ = "";
		$keyGetQ.="editid1=".rawurldecode($keys["ICCID"])."&";
	// cut last &
	$keyGetQ = substr($keyGetQ, 0, strlen($keyGetQ)-1);	
	// redirect
	HeaderRedirect("simcards_batches_query", $pageObject->getPageType(), $keyGetQ);
...
if(!$data)
{
	...
	{
		HeaderRedirect("simcards_batches_query", "list", "a=return");
		exit();
	}
	else
		$data = array();
...
//	POS_Number - 
	$value = $pageObject->showDBValue("POS_Number", $data, $keylink);
	$showValues["POS_Number"] = $value;
	$showFields[] = "POS_Number";
		$showRawValues["POS_Number"] = substr($data["POS_Number"],0,100);

//	FL_or_POS_Name - 
	$value = $pageObject->showDBValue("FL_or_POS_Name", $data, $keylink);
	$showValues["FL_or_POS_Name"] = $value;
	$showFields[] = "FL_or_POS_Name";
		$showRawValues["FL_or_POS_Name"] = substr($data["FL_or_POS_Name"],0,100);

//	TL_Name - 
	$value = $pageObject->showDBValue("TL_Name", $data, $keylink);
	$showValues["TL_Name"] = $value;
	$showFields[] = "TL_Name";
		$showRawValues["TL_Name"] = substr($data["TL_Name"],0,100);

//	SC_DSO_RDO_Name - 
	$value = $pageObject->showDBValue("SC_DSO_RDO_Name", $data, $keylink);
	$showValues["SC_DSO_RDO_Name"] = $value;
	$showFields[] = "SC_DSO_RDO_Name";
		$showRawValues["SC_DSO_RDO_Name"] = substr($data["SC_DSO_RDO_Name"],0,100);

//	batch_name - 
	$value = $pageObject->showDBValue("batch_name", $data, $keylink);
	$showValues["batch_name"] = $value;
	$showFields[] = "batch_name";
		$showRawValues["batch_name"] = substr($data["batch_name"],0,100);

//	ICCID - 
	$value = $pageObject->showDBValue("ICCID", $data, $keylink);
	$showValues["ICCID"] = $value;
	$showFields[] = "ICCID";
		$showRawValues["ICCID"] = substr($data["ICCID"],0,100);
...
//	Form_Returned - 
	...
	$showValues["Form_Returned"] = $value;
	$showFields[] = "Form_Returned";
		$showRawValues["Form_Returned"] = substr($data["Form_Returned"],0,100);

//	time - 
	$value = $pageObject->showDBValue("time", $data, $keylink);
	$showValues["time"] = $value;
	$showFields[] = "time";
		$showRawValues["time"] = substr($data["time"],0,100);

//	Activation_Status - 
	$value = $pageObject->showDBValue("Activation_Status", $data, $keylink);
	$showValues["Activation_Status"] = $value;
	$showFields[] = "Activation_Status";
		$showRawValues["Activation_Status"] = substr($data["Activation_Status"],0,100);

//	Active_MSISDN - 
	$value = $pageObject->showDBValue("Active_MSISDN", $data, $keylink);
	$showValues["Active_MSISDN"] = $value;
	$showFields[] = "Active_MSISDN";
		$showRawValues["Active_MSISDN"] = substr($data["Active_MSISDN"],0,100);

//	New_MSISDN - Custom
	$value = $pageObject->showDBValue("New_MSISDN", $data, $keylink);
	$showValues["New_MSISDN"] = $value;
	$showFields[] = "New_MSISDN";
		$showRawValues["New_MSISDN"] = substr($data["New_MSISDN"],0,100);

//	Airtime_transered - 
	$value = $pageObject->showDBValue("Airtime_transered", $data, $keylink);
	$showValues["Airtime_transered"] = $value;
	$showFields[] = "Airtime_transered";
		$showRawValues["Airtime_transered"] = substr($data["Airtime_transered"],0,100);

//	Transfer_date - 
	$value = $pageObject->showDBValue("Transfer_date", $data, $keylink);
	$showValues["Transfer_date"] = $value;
	$showFields[] = "Transfer_date";
		$showRawValues["Transfer_date"] = substr($data["Transfer_date"],0,100);

//	Activation_Commission - 
	$value = $pageObject->showDBValue("Activation_Commission", $data, $keylink);
	$showValues["Activation_Commission"] = $value;
	$showFields[] = "Activation_Commission";
		$showRawValues["Activation_Commission"] = substr($data["Activation_Commission"],0,100);

//	Form_Commission - 
	$value = $pageObject->showDBValue("Form_Commission", $data, $keylink);
	$showValues["Form_Commission"] = $value;
	$showFields[] = "Form_Commission";
		$showRawValues["Form_Commission"] = substr($data["Form_Commission"],0,100);

//	Form_Paid_Date - 
	$value = $pageObject->showDBValue("Form_Paid_Date", $data, $keylink);
	$showValues["Form_Paid_Date"] = $value;
	$showFields[] = "Form_Paid_Date";
		$showRawValues["Form_Paid_Date"] = substr($data["Form_Paid_Date"],0,100);

//	Form_Status - 
	$value = $pageObject->showDBValue("Form_Status", $data, $keylink);
	$showValues["Form_Status"] = $value;
	$showFields[] = "Form_Status";
		$showRawValues["Form_Status"] = substr($data["Form_Status"],0,100);

//	Swap_Date - 
	$value = $pageObject->showDBValue("Swap_Date", $data, $keylink);
	$showValues["Swap_Date"] = $value;
	$showFields[] = "Swap_Date";
		$showRawValues["Swap_Date"] = substr($data["Swap_Date"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		if ($dpParams['type'][$d] == "chart")
		{
			...
			$options['masterTable'] = "simcards_batches_query";
			$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("simcards_batches_query", "view", $viewlink)."'\"");
