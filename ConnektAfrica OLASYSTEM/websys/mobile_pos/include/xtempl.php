...
<?php if( isset( $params["dash"] ) && $params["dash"] ) { ?>
	xmlFile += '&dashChart=<?php echo $params["dash"] ?>';
<?php } ?>	
<?php if( isset( $params["dashTName"] ) && $params["dashTName"] ) { ?>
	xmlFile += '&dashTName=<?php echo $params["dashTName"] ?>';
	xmlFile += '&dashElName=<?php echo $params["dashElementName"] ?>';
	xmlFile += '&pageId=<?php echo $params["id"] ?>';
	$.ajax( {
		type: "GET",
		url: xmlFile,
		dataType: "xml",
