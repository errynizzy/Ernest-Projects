...
class ConnectionManager
{
	...
	{
		return $this->byId( "connektafrica_pos_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "connektafrica_pos_at_localhost";
		...
		$connectionsData["connektafrica_pos_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["Efficiency"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Effectiveness"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Stock Availability"] = "connektafrica_pos_at_localhost";
		$connectionsIds["New Outlets Per week"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Registration forms outstanding"] = "connektafrica_pos_at_localhost";
		$connectionsIds["SIMS Sold from Outlets "] = "connektafrica_pos_at_localhost";
		$connectionsIds["Airtime into the Channel "] = "connektafrica_pos_at_localhost";
		$connectionsIds["Channel to Customers "] = "connektafrica_pos_at_localhost";
		$connectionsIds["DSO Dashboard"] = "connektafrica_pos_at_localhost";
