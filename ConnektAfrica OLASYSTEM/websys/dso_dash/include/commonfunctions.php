...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Efficiency" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Effectiveness" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Stock_Availability" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("New_Outlets_Per_week" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Registration_forms_outstanding" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("SIMS_Sold_from_Outlets_" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Airtime_into_the_Channel_" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Channel_to_Customers_" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("DSO_Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("Efficiency");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Efficiency";
	}
	$strPerm = GetUserPermissions("Effectiveness");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Effectiveness";
	}
	$strPerm = GetUserPermissions("Stock Availability");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Stock Availability";
	}
	$strPerm = GetUserPermissions("New Outlets Per week");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="New Outlets Per week";
	}
	$strPerm = GetUserPermissions("Registration forms outstanding");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Registration forms outstanding";
	}
	$strPerm = GetUserPermissions("SIMS Sold from Outlets ");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SIMS Sold from Outlets ";
	}
	$strPerm = GetUserPermissions("Airtime into the Channel ");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Airtime into the Channel ";
	}
	$strPerm = GetUserPermissions("Channel to Customers ");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Channel to Customers ";
	}
	$strPerm = GetUserPermissions("DSO Dashboard");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DSO Dashboard";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="Efficiency" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Efficiency" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Efficiency" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	...
	if($table=="Effectiveness" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Effectiveness" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Effectiveness" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Effectiveness")
	{
		return "SP".$extraPerm;
	}
	if($table=="Stock Availability" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Stock Availability" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Stock Availability" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Stock Availability")
	{
		return "SP".$extraPerm;
	}
	if($table=="New Outlets Per week" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="New Outlets Per week" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="New Outlets Per week" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="New Outlets Per week")
	{
		return "SP".$extraPerm;
	}
	if($table=="Registration forms outstanding" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Registration forms outstanding" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Registration forms outstanding" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Registration forms outstanding")
	{
		return "SP".$extraPerm;
	}
	if($table=="SIMS Sold from Outlets " && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="SIMS Sold from Outlets " && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="SIMS Sold from Outlets " && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="SIMS Sold from Outlets ")
	{
		return "SP".$extraPerm;
	}
	if($table=="Airtime into the Channel " && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Airtime into the Channel " && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Airtime into the Channel " && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Airtime into the Channel ")
	{
		return "SP".$extraPerm;
	}
	if($table=="Channel to Customers " && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
	if($table=="Channel to Customers " && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Channel to Customers " && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Channel to Customers ")
	{
		return "SP".$extraPerm;
	}
	if($table=="DSO Dashboard" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
	if($table=="DSO Dashboard" && $sUserGroup=="2")
	{
			return "S".$extraPerm;
	}
	if($table=="DSO Dashboard" && $sUserGroup=="1")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="DSO Dashboard")
	{
		return "S".$extraPerm;
	}
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("users")
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null)
{
	...
	$_SESSION["_Efficiency_OwnerID"] = $data["active"];
