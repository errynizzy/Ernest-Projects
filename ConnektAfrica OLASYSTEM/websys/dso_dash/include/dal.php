...
{
	$connection = getDefaultConnection();
	$data = $connection->query( $dalSQL )->fetchAssoc();
...
class tDAL
{
	var $activated_sims;
	var $activators;
	var $dso_dash_searches;
	var $paid;
	var $pos_live_balance;
	var $pos_live_balancep;
	var $pos_out;
	var $pos_visits;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "activated_sims", "varname" => "activated_sims", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "activators", "varname" => "activators", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "dso_dash_searches", "varname" => "dso_dash_searches", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "paid", "varname" => "paid", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "pos_live_balance", "varname" => "pos_live_balance", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "pos_live_balancep", "varname" => "pos_live_balancep", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "pos_out", "varname" => "pos_out", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "pos_visits", "varname" => "pos_visits", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "simcards_batches", "varname" => "simcards_batches", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "users", "connId" => "connektafrica_pos_at_localhost");
	}
