...
function GetTableURL($table = "")
{
	...
	if("Efficiency" == $table) 
		return "Efficiency";
	if("Effectiveness" == $table) 
		return "Effectiveness";
	if("Stock Availability" == $table) 
		return "Stock_Availability";
	if("New Outlets Per week" == $table) 
		return "New_Outlets_Per_week";
	if("Registration forms outstanding" == $table) 
		return "Registration_forms_outstanding";
	if("SIMS Sold from Outlets " == $table) 
		return "SIMS_Sold_from_Outlets_";
	if("Airtime into the Channel " == $table) 
		return "Airtime_into_the_Channel_";
	if("Channel to Customers " == $table) 
		return "Channel_to_Customers_";
	if("DSO Dashboard" == $table) 
...
{	
	...
	if(!$shortTName)
		return false;
	if("Efficiency" == $shortTName) 
		return "Efficiency";
	if("Effectiveness" == $shortTName) 
		return "Effectiveness";
	if("Stock_Availability" == $shortTName) 
		return "Stock Availability";
	if("New_Outlets_Per_week" == $shortTName) 
		return "New Outlets Per week";
	if("Registration_forms_outstanding" == $shortTName) 
		return "Registration forms outstanding";
	if("SIMS_Sold_from_Outlets_" == $shortTName) 
		return "SIMS Sold from Outlets ";
	if("Airtime_into_the_Channel_" == $shortTName) 
		return "Airtime into the Channel ";
	if("Channel_to_Customers_" == $shortTName) 
		return "Channel to Customers ";
	if("DSO_Dashboard" == $shortTName) 
		return "DSO Dashboard";
}
