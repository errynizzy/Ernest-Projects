...
class tDAL
{
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "returned_iccid", "varname" => "returned_iccid", "connId" => "connektafrica_pos_at_localhost");
		$this->lstTables[] = array("name" => "returned_msisdn", "varname" => "returned_msisdn", "connId" => "connektafrica_pos_at_localhost");
