...
class FilterValuesList extends FilterControl
{
	 ...
	 * the corresponding data if the current filter is dependant
	 */
	 ...
	 * the corresponding data if the current filter has any dependant filter
	 */
	...
	/**
	 * Get extra select columns list for a dependant filter
	 * @return String
	 */
	...
	/**
	 * Check if the current filter has any dependant filtered 'on demand' filter
	 * @return Boolean
	 */
	...
	/**
	 * Get the main filter's and dependant blocks merged
