...
$page_layouts["controller_view"] = $layout;
...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "Sales_Coordinator_Name";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Sales_Coordinator_Name");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Sales_Coordinator_Number";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Sales_Coordinator_Number");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Team_Leader_Name";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Team_Leader_Name");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Team_Leader_Number";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Team_Leader_Number");
$fieldsArr[] = $arr;
...
while($data)
{
	...
	if( $mainTableOwnerID == "Sales_Coordinator_Name" )
		$ownerIdValue = $value;
	$xt->assign("Sales_Coordinator_Name_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("Sales_Coordinator_Name");
	$value = $pageObject->showDBValue("Sales_Coordinator_Number", $data, $keylink);
	if( $mainTableOwnerID == "Sales_Coordinator_Number" )
		$ownerIdValue = $value;
	$xt->assign("Sales_Coordinator_Number_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("Sales_Coordinator_Number");
	$value = $pageObject->showDBValue("Team_Leader_Name", $data, $keylink);
	if( $mainTableOwnerID == "Team_Leader_Name" )
		$ownerIdValue = $value;
	$xt->assign("Team_Leader_Name_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("Team_Leader_Name");
	$value = $pageObject->showDBValue("Team_Leader_Number", $data, $keylink);
	if( $mainTableOwnerID == "Team_Leader_Number" )
		$ownerIdValue = $value;
	$xt->assign("Team_Leader_Number_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("Team_Leader_Number");
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("controller", "edit", $editlink)."'\"");
