...
$page_layouts["simcards_edit"] = $layout;
...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("simcards", "inline_edit");
else 
	$templatefile = GetTemplateName("simcards", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("simcards", $pageObject->getPageType(), $keyGetQ);
...
//	supplier_name - 
	...
	$showValues["supplier_name"] = $value;
...
//	supplier_number - 
	...
	$showValues["supplier_number"] = $value;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("simcards", "view", $viewlink)."'\"");
