...
$page_layouts["Copy_of_simcards_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = GetTemplateName("Copy_of_simcards", "search");
...
$params['shortTableName'] = 'Copy_of_simcards';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	else
	{
		...
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = $pageObject->pSet->getDefaultValue( "Total" );
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
		$firstFieldParams['not'] = false;
	}
