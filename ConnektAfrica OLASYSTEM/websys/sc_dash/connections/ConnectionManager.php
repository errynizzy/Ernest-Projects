...
class ConnectionManager
{
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["Activations and Airtime Transfers"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Average Airtime Consumption 3 Months"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Registration Forms Outstanding  "] = "connektafrica_pos_at_localhost";
		$connectionsIds["Active Freelancers "] = "connektafrica_pos_at_localhost";
		$connectionsIds["Active Freelancers per TL"] = "connektafrica_pos_at_localhost";
		$connectionsIds["Activations per active FL"] = "connektafrica_pos_at_localhost";
		$connectionsIds["SC Dashboard"] = "connektafrica_pos_at_localhost";
