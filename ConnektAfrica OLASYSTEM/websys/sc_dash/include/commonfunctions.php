...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Activations_and_Airtime_Transfers" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Average_Airtime_Consumption_3_Months" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Registration_Forms_Outstanding__" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Active_Freelancers_" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Active_Freelancers_per_TL" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Activations_per_active_FL" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("SC_Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("Activations and Airtime Transfers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Activations and Airtime Transfers";
	}
	$strPerm = GetUserPermissions("Average Airtime Consumption 3 Months");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Average Airtime Consumption 3 Months";
	}
	...
	$strPerm = GetUserPermissions("Active Freelancers ");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Active Freelancers ";
	}
	$strPerm = GetUserPermissions("Active Freelancers per TL");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Active Freelancers per TL";
	}
	$strPerm = GetUserPermissions("Activations per active FL");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Activations per active FL";
	}
	$strPerm = GetUserPermissions("SC Dashboard");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SC Dashboard";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="Activations and Airtime Transfers" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Activations and Airtime Transfers" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Activations and Airtime Transfers" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Activations and Airtime Transfers")
	{
		return "SP".$extraPerm;
	}
	if($table=="Average Airtime Consumption 3 Months" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Average Airtime Consumption 3 Months" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Average Airtime Consumption 3 Months" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Average Airtime Consumption 3 Months")
	{
		return "SP".$extraPerm;
	}
...
//	default permissions	
	...
	if($table=="Active Freelancers " && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Active Freelancers " && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Active Freelancers " && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Active Freelancers ")
	{
		return "SP".$extraPerm;
	}
	if($table=="Active Freelancers per TL" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Active Freelancers per TL" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Active Freelancers per TL" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Active Freelancers per TL")
	{
		return "SP".$extraPerm;
	}
	if($table=="Activations per active FL" && $sUserGroup=="1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Activations per active FL" && $sUserGroup=="2")
	{
			return "SP".$extraPerm;
	}
	if($table=="Activations per active FL" && $sUserGroup=="3")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Activations per active FL")
	{
		return "SP".$extraPerm;
	}
	if($table=="SC Dashboard" && $sUserGroup=="1")
	{
			return "S".$extraPerm;
	}
	if($table=="SC Dashboard" && $sUserGroup=="2")
	{
			return "S".$extraPerm;
	}
	if($table=="SC Dashboard" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="SC Dashboard")
	{
		return "S".$extraPerm;
	}
