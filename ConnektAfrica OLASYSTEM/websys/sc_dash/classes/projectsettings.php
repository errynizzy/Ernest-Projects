...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("Activations and Airtime Transfers" == $table) 
		return "Activations_and_Airtime_Transfers";
	if("Average Airtime Consumption 3 Months" == $table) 
		return "Average_Airtime_Consumption_3_Months";
	if("Registration Forms Outstanding  " == $table) 
		return "Registration_Forms_Outstanding__";
	if("Active Freelancers " == $table) 
		return "Active_Freelancers_";
	if("Active Freelancers per TL" == $table) 
		return "Active_Freelancers_per_TL";
	if("Activations per active FL" == $table) 
		return "Activations_per_active_FL";
	if("SC Dashboard" == $table) 
		return "SC_Dashboard";
...
{	
	...
	if(!$shortTName)
		return false;
	if("Activations_and_Airtime_Transfers" == $shortTName) 
		return "Activations and Airtime Transfers";
	if("Average_Airtime_Consumption_3_Months" == $shortTName) 
		return "Average Airtime Consumption 3 Months";
	if("Registration_Forms_Outstanding__" == $shortTName) 
		return "Registration Forms Outstanding  ";
	if("Active_Freelancers_" == $shortTName) 
		return "Active Freelancers ";
	if("Active_Freelancers_per_TL" == $shortTName) 
		return "Active Freelancers per TL";
	if("Activations_per_active_FL" == $shortTName) 
		return "Activations per active FL";
	if("SC_Dashboard" == $shortTName) 
		return "SC Dashboard";
}
