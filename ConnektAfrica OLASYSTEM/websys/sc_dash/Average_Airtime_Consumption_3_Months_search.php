...
include("include/Average_Airtime_Consumption_3_Months_variables.php");
...
$page_layouts["Average_Airtime_Consumption_3_Months_search"] = $layout;
...
include('classes/searchpage.php');
include('classes/searchpage_dash.php');
$xt = new Xtempl();
...
$params['shortTableName'] = 'Average_Airtime_Consumption_3_Months';
