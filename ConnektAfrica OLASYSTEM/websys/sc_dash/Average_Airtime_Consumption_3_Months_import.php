...
include('classes/importpage.php');
...
$layout = new TLayout("import2", "RoundedBlue_white", "MobileBlue_white");
$layout->version = 2;
...
$page_layouts["Average_Airtime_Consumption_3_Months_import"] = $layout;
