...
include("include/Activations_per_active_FL_variables.php");
...
$page_layouts["Activations_per_active_FL_search"] = $layout;
...
$params['shortTableName'] = 'Activations_per_active_FL';
