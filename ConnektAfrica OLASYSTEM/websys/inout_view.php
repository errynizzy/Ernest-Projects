...
$page_layouts["inout_view"] = $layout;
...
while($data)
{
	...
	if( $mainTableOwnerID == "ACCT_BOOK_ID" )
		$ownerIdValue = $value;
	$xt->assign("ACCT_BOOK_ID_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("ACCT_BOOK_ID");
	...
	if( $mainTableOwnerID == "CUST_NAME" )
		$ownerIdValue = $value;
	$xt->assign("CUST_NAME_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("CUST_NAME");
	...
	if( $mainTableOwnerID == "PRE_BALANCE" )
		$ownerIdValue = $value;
	$xt->assign("PRE_BALANCE_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("PRE_BALANCE");
	$value = $pageObject->showDBValue("CHARGE", $data, $keylink);
	if( $mainTableOwnerID == "CHARGE" )
		$ownerIdValue = $value;
	$xt->assign("CHARGE_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("CHARGE");
	$value = $pageObject->showDBValue("TRANSFER_MODE", $data, $keylink);
	if( $mainTableOwnerID == "TRANSFER_MODE" )
		$ownerIdValue = $value;
	$xt->assign("TRANSFER_MODE_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("TRANSFER_MODE");
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("inout", "edit", $editlink)."'\"");
