...
class LookupField extends EditControl
{
	...
	{
		if( $this->connection->dbType != nDATABASE_MySQL || $this->connection->dbType != nDATABASE_MSSQLServer || $this->connection->dbType != nDATABASE_PostgreSQL )
			return false;
	...
	{		
		...
		$searchFor = $this->connection->escapeLIKEpattern( $searchOpt == 'Contains' ? '%'.$searchFor.'%' : $searchFor.'%' );
