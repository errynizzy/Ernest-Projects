...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("outside_stock", "inline_edit");
else 
	$templatefile = GetTemplateName("outside_stock", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("outside_stock", $pageObject->getPageType(), $keyGetQ);
...
//	Form_Date - 
	$value = $pageObject->showDBValue("Form_Date", $data, $keylink);
	$showValues["Form_Date"] = $value;
	$showFields[] = "Form_Date";
		$showRawValues["Form_Date"] = substr($data["Form_Date"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("outside_stock", "view", $viewlink)."'\"");
