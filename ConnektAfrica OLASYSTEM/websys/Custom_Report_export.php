...
$page_layouts["Custom_Report_export"] = $layout;
...
$pageObject->display(GetTemplateName("Custom_Report", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","supplier_name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","supplier_number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","batch_name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","ICCID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","Event_date")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","time")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","Activation_Status")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","Activator_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Custom_Report","Active_MSISDN")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("Custom_Report","supplier_name")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","supplier_number")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","batch_name")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","ICCID")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","Event_date")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","time")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","Activation_Status")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","Activator_Number")."</td>";
		echo "<td>".GetFieldLabel("Custom_Report","Active_MSISDN")."</td>";
	}
	echo "</tr>";
