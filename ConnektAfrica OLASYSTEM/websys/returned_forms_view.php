...
$layout = new TLayout("view_basic_2col_center", "RoundedBlue_white", "MobileBlue_white");
$layout->version = 2;
...
$page_layouts["returned_forms_view"] = $layout;
...
if (!sizeof($data)) 
{
	HeaderRedirect("returned_forms", "list", "a=return");
	exit();
}
...
if($pageObject->isShowDetailTables && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		if ($dpParams['type'][$d] == "chart")
		{
			...
			$options['masterTable'] = "returned_forms";
			$options['firstTime'] = 1;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("returned_forms", "edit", $editlink)."'\"");
