...
$page_layouts["Copy_of_batches_export"] = $layout;
...
$pageObject->display(GetTemplateName("Copy_of_batches", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Copy_of_batches","Batch_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Copy_of_batches","Given_Batch_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Copy_of_batches","Batch_size")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Copy_of_batches","Status")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("Copy_of_batches","Batch_Number")."</td>";
		echo "<td>".GetFieldLabel("Copy_of_batches","Given_Batch_Number")."</td>";
		echo "<td>".GetFieldLabel("Copy_of_batches","Batch_size")."</td>";
		echo "<td>".GetFieldLabel("Copy_of_batches","Status")."</td>";
	}
	echo "</tr>";
