...
$page_layouts["outside_stock_export"] = $layout;
...
$pageObject->display(GetTemplateName("outside_stock", "export"));
...
function ExportToXML($rs, $nPageSize, $strTableName, $eventObj, $cipherer, $pageObject)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["Status"] = $pageObject->getExportValue("Status", $row);
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["Status"] = $pageObject->getViewControl("Status")->getExportValue($row, "");
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Manager_Title")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Activator_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Activator_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Team_Leader")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Manager_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Event_date")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","time")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Status")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","ICCID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Active_MSISDN")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","New_MSISDN")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Swap_Date")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Airtime_transered")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Transfer_date")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Activation_Commission")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Form_Returned")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Form_Status")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Form_Commission")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("outside_stock","Form_Paid_Date")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("outside_stock","Manager_Title")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Activator_Number")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Activator_Name")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Team_Leader")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Manager_Name")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Event_date")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","time")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Status")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","ICCID")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Active_MSISDN")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","New_MSISDN")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Swap_Date")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Airtime_transered")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Transfer_date")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Activation_Commission")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Form_Returned")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Form_Status")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Form_Commission")."</td>";
		echo "<td>".GetFieldLabel("outside_stock","Form_Paid_Date")."</td>";
	}
	echo "</tr>";
