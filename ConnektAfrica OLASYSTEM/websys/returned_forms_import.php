...
$strOriginalTableName="`returned_forms`";
...
$layout = new TLayout("import", "RoundedBlue_white", "MobileBlue_white");
$layout->version = 2;
...
$page_layouts["returned_forms_import"] = $layout;
...
$pageObject->display(GetTemplateName("returned_forms", "import"));
