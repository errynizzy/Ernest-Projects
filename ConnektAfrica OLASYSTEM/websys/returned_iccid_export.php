...
$page_layouts["returned_iccid_export"] = $layout;
...
$pageObject->display(GetTemplateName("returned_iccid", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_iccid","ID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_iccid","ICCID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_iccid","Status")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_iccid","Date")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("returned_iccid","ID")."</td>";
		echo "<td>".GetFieldLabel("returned_iccid","ICCID")."</td>";
		echo "<td>".GetFieldLabel("returned_iccid","Status")."</td>";
		echo "<td>".GetFieldLabel("returned_iccid","Date")."</td>";
	}
	echo "</tr>";
