...
$page_layouts["activated_sims_export"] = $layout;
...
$pageObject->display(GetTemplateName("activated_sims", "export"));
...
function ExportToXML($rs, $nPageSize, $strTableName, $eventObj, $cipherer, $pageObject)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["Subscriber_ICCID"] = $pageObject->getExportValue("Subscriber_ICCID", $row);
			$values["Subscriber_Number"] = $pageObject->getExportValue("Subscriber_Number", $row);
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Subscriber_ICCID\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Subscriber_Number\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Event_date\"";
	if($outstr!="")
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["Subscriber_ICCID"] = $pageObject->getViewControl("Subscriber_ICCID")->getExportValue($row, "");
			$values["Subscriber_Number"] = $pageObject->getViewControl("Subscriber_Number")->getExportValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Subscriber_ICCID"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Subscriber_Number"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("activated_sims","Activator_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("activated_sims","Subscriber_ICCID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("activated_sims","Subscriber_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("activated_sims","Event_date")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("activated_sims","time")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("activated_sims","Activator_Number")."</td>";
		echo "<td>".GetFieldLabel("activated_sims","Subscriber_ICCID")."</td>";
		echo "<td>".GetFieldLabel("activated_sims","Subscriber_Number")."</td>";
		echo "<td>".GetFieldLabel("activated_sims","Event_date")."</td>";
		echo "<td>".GetFieldLabel("activated_sims","time")."</td>";
	}
	echo "</tr>";
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["Subscriber_ICCID"]);
					else
						echo $values["Subscriber_ICCID"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["Subscriber_Number"]);
					else
						echo $values["Subscriber_Number"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
