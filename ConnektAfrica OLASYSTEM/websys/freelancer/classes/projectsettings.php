...
function GetTableURL($table = "")
{
	...
	if("activators" == $table) 
		return "activators";
	if("Copy of controller" == $table) 
		return "Copy_of_controller";
	if("Copy of Copy of controller" == $table) 
		return "Copy_of_Copy_of_controller";
	if("Copy of Copy of Copy of controller" == $table) 
		return "Copy_of_Copy_of_Copy_of_controller";
	if("Copy of controller1" == $table) 
		return "Copy_of_controller1";
...
{	
	...
	if("activators" == $shortTName) 
		return "activators";
	if("Copy_of_controller" == $shortTName) 
		return "Copy of controller";
	if("Copy_of_Copy_of_controller" == $shortTName) 
		return "Copy of Copy of controller";
	if("Copy_of_Copy_of_Copy_of_controller" == $shortTName) 
		return "Copy of Copy of Copy of controller";
	if("Copy_of_controller1" == $shortTName) 
		return "Copy of controller1";
}
