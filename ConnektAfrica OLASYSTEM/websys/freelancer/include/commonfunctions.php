...
function checkTableName($shortTName, $type=false)
{
	...
	if ("activators" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Copy_of_controller" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_Copy_of_controller" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_Copy_of_Copy_of_controller" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_controller1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("Copy of controller");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of controller";
	}
	$strPerm = GetUserPermissions("Copy of Copy of controller");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of Copy of controller";
	}
	$strPerm = GetUserPermissions("Copy of Copy of Copy of controller");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of Copy of Copy of controller";
	}
	$strPerm = GetUserPermissions("Copy of controller1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of controller1";
	}
	return $arr;
}
...
//	default permissions	
	...
	if($table=="Copy of controller" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of controller" && $sUserGroup=="2")
	{
			return "AESPI".$extraPerm;
	}
//	default permissions	
	if($table=="Copy of controller")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of Copy of controller" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of Copy of controller" && $sUserGroup=="2")
	{
			return "AESPI".$extraPerm;
	}
//	default permissions	
	if($table=="Copy of Copy of controller")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of Copy of Copy of controller" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of Copy of Copy of controller" && $sUserGroup=="2")
	{
			return "AESPI".$extraPerm;
	}
//	default permissions	
	if($table=="Copy of Copy of Copy of controller")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of controller1" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Copy of controller1" && $sUserGroup=="2")
	{
			return "AESPI".$extraPerm;
	}
//	default permissions	
	if($table=="Copy of controller1")
	{
		return "AEDSPI".$extraPerm;
	}
