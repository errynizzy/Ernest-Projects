...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "activators", "varname" => "activators", "connId" => "Tables");
		$this->lstTables[] = array("name" => "controller", "varname" => "controller", "connId" => "Tables");
		$this->lstTables[] = array("name" => "team_leader", "varname" => "team_leader", "connId" => "Tables");
		$this->lstTables[] = array("name" => "title_lookup", "varname" => "title_lookup", "connId" => "Tables");
		$this->lstTables[] = array("name" => "users", "varname" => "users", "connId" => "Tables");
	}
