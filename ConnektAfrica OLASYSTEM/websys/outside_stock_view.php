...
$page_layouts["outside_stock_view"] = $layout;
...
if (!sizeof($data)) 
{
	HeaderRedirect("outside_stock", "list", "a=return");
	exit();
}
...
if($pageObject->isShowDetailTables && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		if ($dpParams['type'][$d] == "chart")
		{
			...
			$options['masterTable'] = "outside_stock";
			$options['firstTime'] = 1;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("outside_stock", "edit", $editlink)."'\"");
