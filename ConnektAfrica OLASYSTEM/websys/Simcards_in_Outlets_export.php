...
include("include/Simcards_in_Outlets_variables.php");
...
$page_layouts["Simcards_in_Outlets_export"] = $layout;
...
$pageObject->display(GetTemplateName("Simcards_in_Outlets", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Simcards_in_Outlets","pos_number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Simcards_in_Outlets","supplier_name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Simcards_in_Outlets","Total")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("Simcards_in_Outlets","pos_number")."</td>";
		echo "<td>".GetFieldLabel("Simcards_in_Outlets","supplier_name")."</td>";
		echo "<td>".GetFieldLabel("Simcards_in_Outlets","Total")."</td>";
	}
	echo "</tr>";
