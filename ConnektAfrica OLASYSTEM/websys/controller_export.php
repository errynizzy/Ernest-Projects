...
$page_layouts["controller_export"] = $layout;
...
$pageObject->display(GetTemplateName("controller", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("controller","Sales_Coordinator_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("controller","Sales_Coordinator_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("controller","Team_Leader_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("controller","Team_Leader_Number")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("controller","Sales_Coordinator_Name")."</td>";
		echo "<td>".GetFieldLabel("controller","Sales_Coordinator_Number")."</td>";
		echo "<td>".GetFieldLabel("controller","Team_Leader_Name")."</td>";
		echo "<td>".GetFieldLabel("controller","Team_Leader_Number")."</td>";
	}
	echo "</tr>";
