...
$page_layouts["returned_msisdn_export"] = $layout;
...
$pageObject->display(GetTemplateName("returned_msisdn", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_msisdn","ID")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_msisdn","MSISDN")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_msisdn","Status")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("returned_msisdn","Date")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("returned_msisdn","ID")."</td>";
		echo "<td>".GetFieldLabel("returned_msisdn","MSISDN")."</td>";
		echo "<td>".GetFieldLabel("returned_msisdn","Status")."</td>";
		echo "<td>".GetFieldLabel("returned_msisdn","Date")."</td>";
	}
	echo "</tr>";
