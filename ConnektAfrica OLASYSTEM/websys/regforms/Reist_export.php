...
$page_layouts["Reist_export"] = $layout;
...
$pageObject->display(GetTemplateName("Reist", "export"));
...
function ExportToXML($rs, $nPageSize, $strTableName, $eventObj, $cipherer, $pageObject)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["Active"] = $pageObject->getExportValue("Active", $row);
			$values["Returned_Forms"] = $pageObject->getExportValue("Returned_Forms", $row);
			$values["Rejected_Forms"] = $pageObject->getExportValue("Rejected_Forms", $row);
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Returned_Forms\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Rejected_Forms\"";
	echo $outstr;
	echo "\r\n";
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["Returned_Forms"] = $row["Returned_Forms"];
			$values["Rejected_Forms"] = $row["Rejected_Forms"];
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Returned_Forms"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Rejected_Forms"]).'"';
			echo $outstr;
		}
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Activator_Number")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Activator_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Manager_Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Active")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Returned_Forms")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("Reist","Rejected_Forms")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("Reist","Activator_Number")."</td>";
		echo "<td>".GetFieldLabel("Reist","Activator_Name")."</td>";
		echo "<td>".GetFieldLabel("Reist","Manager_Name")."</td>";
		echo "<td>".GetFieldLabel("Reist","Active")."</td>";
		echo "<td>".GetFieldLabel("Reist","Returned_Forms")."</td>";
		echo "<td>".GetFieldLabel("Reist","Rejected_Forms")."</td>";
	}
	echo "</tr>";
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values = array();
					...
					$values["Activator_Name"] = $pageObject->getViewControl("Activator_Name")->getExportValue($row, "");
					$values["Manager_Name"] = $pageObject->getViewControl("Manager_Name")->getExportValue($row, "");
					$values["Active"] = $pageObject->getViewControl("Active")->getExportValue($row, "");
					$values["Returned_Forms"] = $pageObject->getViewControl("Returned_Forms")->getExportValue($row, "");
					$values["Rejected_Forms"] = $pageObject->getViewControl("Rejected_Forms")->getExportValue($row, "");
		...
		if ($eventRes)
		{
			...
			echo '</td>';
							echo '<td>';
									...
									echo $values["Returned_Forms"];
			echo '</td>';
							echo '<td>';
			
									echo $values["Rejected_Forms"];
			echo '</td>';
			echo "</tr>";
		}
