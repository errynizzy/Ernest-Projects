...
$page_layouts["Copy_of_batches_view"] = $layout;
...
while($data)
{
	...
	if( $mainTableOwnerID == "Given_Batch_Number" )
		$ownerIdValue = $value;
	$xt->assign("Given_Batch_Number_value",$value);
	...
	if( $hideEmptyFields && $value == "" ) 
		$pageObject->hideField("Given_Batch_Number");
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("Copy_of_batches", "edit", $editlink)."'\"");
