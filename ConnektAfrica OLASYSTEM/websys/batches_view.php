...
$page_layouts["batches_view"] = $layout;
...
if (!sizeof($data)) 
{
	HeaderRedirect("batches", "list", "a=return");
	exit();
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("batches", "edit", $editlink)."'\"");
