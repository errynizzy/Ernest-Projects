...
public class CheckUpActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // Importing all assets like buttons, text fields 	
        ...
        send_checkup = (Button) findViewById(R.id.send_checkup); 
        btnLinkToHome = (Button) findViewById(R.id.btnLinkToHome); 
        get_check_response = (Button) findViewById(R.id.get_check_response); 
      ...
      //for clinic names 
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_dropdown_item_1line,item);
	        ...
	        AutoCompleteTextView auto2 = (AutoCompleteTextView)findViewById(R.id.issue);
        ...
        //assigning button click events in order
        send_checkup.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (len<=0)
                {
                	issue.setError("This Field is required!");
                }
                else if (len1 <=0){
            ...
            postParameters.add(new BasicNameValuePair("clnc_name", clnc_name.getText().toString()));
             ...
             postParameters.add(new BasicNameValuePair("issue", issue.getText().toString()));
        try {
			response = CustomHttpClient.executeHttpPost("http://10.0.2.2/mvigour/insert_checkup.php",postParameters);
        ...
        get_check_response.setOnClickListener(new View.OnClickListener() {
