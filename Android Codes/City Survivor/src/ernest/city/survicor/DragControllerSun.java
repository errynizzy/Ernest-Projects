...
public class DragControllerSun {
    ...
    private DragSourceSun mDragSource;

    /** The data associated with the object being dragged */
    private Object mDragInfo;

    /** The view that moves around while you drag.  */
    private DragViewSun mDragView;

    /** Who can receive drop events */
    private ArrayList<DropTargetSun> mDropTargets = new ArrayList<DropTargetSun>();
    ...
    private DropTargetSun mLastDropTarget;
     ...
     */
    public DragControllerSun(Context context) {
        mContext = context;
     ...
     */
    public void startDrag(View v, DragSourceSun source, Object dragInfo, int dragAction) {
    ...
    public void startDrag(Bitmap b, int screenX, int screenY,
            ...
            DragSourceSun source, Object dragInfo, int dragAction) {
        ...
        DragViewSun dragView = mDragView = new DragViewSun(mContext, b, registrationX, registrationY,
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            DropTargetSun dropTarget = findDropTarget(screenX, screenY, coordinates);
            if (dropTarget != null) {
    ...
    private boolean drop(float x, float y) {
        ...
        final int[] coordinates = mCoordinatesTemp;
        DropTargetSun dropTarget = findDropTarget((int) x, (int) y, coordinates);
    ...
    private DropTargetSun findDropTarget(int x, int y, int[] dropCoordinates) {
        final Rect r = mRectTemp;

        final ArrayList<DropTargetSun> dropTargets = mDropTargets;
        final int count = dropTargets.size();
        for (int i=count-1; i>=0; i--) {
            final DropTargetSun target = dropTargets.get(i);
            target.getHitRect(r);
     ...
     */
    public void addDropTarget(DropTargetSun target) {
     ...
     */
    public void removeDropTarget(DropTargetSun target) {
    ...
    public void removeAllDropTargets () {
        mDropTargets = new ArrayList<DropTargetSun> ();
    }
