...
public class ImageCellSun extends ImageView 
    implements DragSourceSun, DropTargetSun
{
...
public ImageCellSun (Context context) {
	super (context);
}
public ImageCellSun (Context context, AttributeSet attrs) {
	super (context, attrs);
}
public ImageCellSun (Context context, AttributeSet attrs, int style) {
...
public void setDragController (DragControllerSun dragger)
{
...
{
    if (!FirstActivitySun.Debugging) return;
