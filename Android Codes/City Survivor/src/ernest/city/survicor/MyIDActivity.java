    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickListener(new View.OnClickListener(){
         public void onClick(View v) {
          ...
          //the number 1
          try {
     response = CustomHttpClient.executeHttpPost("http://www.mvigour.com/cs/myid.php",postParameters); // your ip address if using localhost server
           ...
           JSONArray jArray = new JSONArray(result);
                 ...
                 for(int i=0;i<jArray.length();i++){
                         ...
                         returnString = "Hello!  " +
                        		 ...
                        		 "\n" + "Your City Survivor ID is: \t"+ json_data.getString("ID")
