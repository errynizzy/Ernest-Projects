...
public class DeleteZoneSun extends ImageView
    implements DropTargetSun
{
...
public DeleteZoneSun (Context context) {
   super  (context);
}
public DeleteZoneSun (Context context, AttributeSet attrs) {
	super (context, attrs);
}
public DeleteZoneSun (Context context, AttributeSet attrs, int style) 
{
...
private DragControllerSun mDragController;
...
public DragControllerSun getDragController ()
{
...
public void setDragController (DragControllerSun newValue)
{
 ...
 * 
 */
public void onDrop(DragSourceSun source, int x, int y, int xOffset, int yOffset,
        DragViewSun dragView, Object dragInfo)
{
 ...
 */    
public void onDragEnter(DragSourceSun source, int x, int y, int xOffset, int yOffset,
        DragViewSun dragView, Object dragInfo)
{
 ...
 */    
public void onDragOver(DragSourceSun source, int x, int y, int xOffset, int yOffset,
        DragViewSun dragView, Object dragInfo)
{
}
 ...
 * Provide the user with some visual feedback.
 */    
public void onDragExit(DragSourceSun source, int x, int y, int xOffset, int yOffset,
        DragViewSun dragView, Object dragInfo)
{
 ...
 */
public boolean acceptDrop(DragSourceSun source, int x, int y, int xOffset, int yOffset,
        DragViewSun dragView, Object dragInfo)
{
    return isEnabled ();
}
 ...
 */
public Rect estimateDropLocation(DragSourceSun source, int x, int y, int xOffset, int yOffset,
            DragViewSun dragView, Object dragInfo, Rect recycle)
{
    return null;
}
...
public void setup (DragControllerSun controller)
{
