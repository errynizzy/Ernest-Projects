...
public class DisplayImageActivity_id_brand extends Activity {
	@Override
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.display_id_brand);
		...
		btnDelete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 */
				DataBaseHandler_id_brand db = new DataBaseHandler_id_brand(
						DisplayImageActivity_id_brand.this);
				/**
				 * Deleting records from database
				 */
				Log.d("Delete Image: ", "Deleting.....");
				db.deleteContact(new Contact_id_brand(imageId));
				// /after deleting data go to main page
				Intent i = new Intent(DisplayImageActivity_id_brand.this,
				...
				buttonSend.setOnClickListener(new View.OnClickListener(){
					        ...
					        public void onClick(View v) {
					            ...
					            try {
									...
									startActivity(i);
									finish();
					    			Intent ii = new Intent(DisplayImageActivity_id_brand.this,
					    					Main_Screen_branding.class);
									startActivity(ii);
									finish();
