...
public class Add_Update_User_scratch_cards extends Activity {
    ...
    String	valid_user_id = "";
    		int USER_ID;
    DatabaseHandler_scratch_cards dbHandler = new DatabaseHandler_scratch_cards(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
	// TODO Auto-generated method stub
	super.onCreate(savedInstanceState);
	setContentView(R.layout.add_update_screen_scratch_cards);
	...
	if (called_from.equalsIgnoreCase("add")) {
	    ...
	    Contact_scratch_cards c = dbHandler.Get_Contact(USER_ID);
	...
	add_save_btn.setOnClickListener(new View.OnClickListener() {
	    ...
	    public void onClick(View v) {
	    	...
	    	valid_business_type = add_business_type.getSelectedItem().toString().toString();
		    ...
		    dbHandler.Add_Contact(new Contact_scratch_cards(valid_name,
			    valid_mob_number, 
			    valid_reg_date,
			    valid_serial_number,
			    valid_phone2,
	...
	update_btn.setOnClickListener(new View.OnClickListener() {
		...
		valid_reg_date = add_reg_date.getText().toString();    
	       ...
	       valid_rdo_name   = add_rdo_name.getText().toString();  
	       valid_rdo_number  = add_rdo_number.getText().toString();  
		    dbHandler.Update_Contact(new Contact_scratch_cards(USER_ID, valid_name,
			    valid_mob_number, 
			    valid_reg_date,     
			       valid_serial_number,     
			       valid_phone2,     
	...
	update_view_all.setOnClickListener(new View.OnClickListener() {
	    ...
	    public void onClick(View v) {
		// TODO Auto-generated method stub
		Intent view_user = new Intent(Add_Update_User_scratch_cards.this,
		...
		public void onClick(View v) {
           ...
           progressBar.setMessage("Saving...");
            ...
            try {
    			...
    			response = CustomHttpClient.executeHttpPost("http://connektafrica.net/pos_app/add_pos.php",postParameters1);
    			//progressBar.dismiss();
    			Intent i = new Intent(Add_Update_User_scratch_cards.this,
    					MainActivity.class);
				startActivity(i);
				finish();
...
img_btn = (Button) findViewById(R.id.img_btn);
	...
	add_business_typeED.setVisibility(View.GONE);
