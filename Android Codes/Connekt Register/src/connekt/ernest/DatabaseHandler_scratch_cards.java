...
public class DatabaseHandler_scratch_cards extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "contactsManagerr";
    ...
    private final ArrayList<Contact_scratch_cards> contact_list = new ArrayList<Contact_scratch_cards>();

    public DatabaseHandler_scratch_cards(Context context) {
    ...
    // Adding new contact
    public void Add_Contact(Contact_scratch_cards contact) {
    ...
    Contact_scratch_cards Get_Contact(int id) {
	...
	Contact_scratch_cards contact = new Contact_scratch_cards(Integer.parseInt(cursor.getString(0)),
		cursor.getString(1), 
		cursor.getString(2), 
		cursor.getString(3),
		cursor.getString(4),
    ...
    public ArrayList<Contact_scratch_cards> Get_Contacts() {
	try {
	    contact_list.clear();
		...
		do {
		    Contact_scratch_cards contact = new Contact_scratch_cards();
    ...
    public int Update_Contact(Contact_scratch_cards contact) {
	SQLiteDatabase db = this.getWritableDatabase();
