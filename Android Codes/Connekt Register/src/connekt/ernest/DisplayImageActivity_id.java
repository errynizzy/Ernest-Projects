...
public class DisplayImageActivity_id extends Activity {
	@Override
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnDelete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 */
				DataBaseHandler_id db = new DataBaseHandler_id(
						DisplayImageActivity_id.this);
				/**
				 * Deleting records from database
				 */
				Log.d("Delete Image: ", "Deleting.....");
				db.deleteContact(new Contact_id(imageId));
				// /after deleting data go to main page
				Intent i = new Intent(DisplayImageActivity_id.this,
				...
				buttonSend.setOnClickListener(new View.OnClickListener(){
					        ...
					        public void onClick(View v) {
					            ...
					            try {
									...
									startActivity(i);
									finish();
					    			Intent ii = new Intent(DisplayImageActivity_id.this,
					    					Main_Screen_mobile.class);
									startActivity(ii);
									finish();
