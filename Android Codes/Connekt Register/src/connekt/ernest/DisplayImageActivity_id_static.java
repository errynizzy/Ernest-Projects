...
public class DisplayImageActivity_id_static extends Activity {
	@Override
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.display_id__static);
		...
		btnDelete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 */
				DataBaseHandler_id_static db = new DataBaseHandler_id_static(
						DisplayImageActivity_id_static.this);
				/**
				 * Deleting records from database
				 */
				Log.d("Delete Image: ", "Deleting.....");
				db.deleteContact(new Contact_id_static(imageId));
				// /after deleting data go to main page
				Intent i = new Intent(DisplayImageActivity_id_static.this,
		...
		//dont mess with this button.....hahahaaaa
				buttonSend.setOnClickListener(new View.OnClickListener(){
					        ...
					        public void onClick(View v) {
					            ...
					            try {
					    			response = CustomHttpClient.executeHttpPost("http://connektafrica.net/pos_app/add_pos_id.php",postParameters1);
					    			/**
									 * create DatabaseHandler object
									 */
									DataBaseHandler_id_static db = new DataBaseHandler_id_static(
									...
									startActivity(i);
									finish();
					    			Intent ii = new Intent(DisplayImageActivity_id_static.this,
					    					Main_Screen_scratch_cards.class);
									startActivity(ii);
									finish();
