...
public class DisplayImageActivity_id_shop_stat extends Activity {
	@Override
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.display_id_shop_stat);
		...
		btnDelete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 */
				DataBaseHandler_id_shop_stat db = new DataBaseHandler_id_shop_stat(
						DisplayImageActivity_id_shop_stat.this);
				/**
				 * Deleting records from database
				 */
				Log.d("Delete Image: ", "Deleting.....");
				db.deleteContact(new Contact_id_shop_stat(imageId));
				// /after deleting data go to main page
				Intent i = new Intent(DisplayImageActivity_id_shop_stat.this,
				...
				buttonSend.setOnClickListener(new View.OnClickListener(){
					        ...
					        public void onClick(View v) {
					            ...
					            try {
									...
									startActivity(i);
									finish();
					    			Intent ii = new Intent(DisplayImageActivity_id_shop_stat.this,
					    					Main_Screen_scratch_cards.class);
									startActivity(ii);
									finish();
