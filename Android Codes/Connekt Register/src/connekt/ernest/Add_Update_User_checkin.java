...
public class Add_Update_User_checkin extends Activity {
	...
	add_save_btn.setOnClickListener(new View.OnClickListener() {
		...
		// check the value state is null or not
	    	 ...
	    	 int len9 = add_lat.length();
	    	 int len10 = add_lon.length();
	    	
	    	 
	    	 if(!add_business_typeED.getText().toString().equals("MOBILE POS") 
	    			 && !add_business_typeED.getText().toString().equals("STATIC POS")
	    			 && !add_business_typeED.getText().toString().equals("FREELANCER")
	    			 && !add_business_typeED.getText().toString().equals("DEALER")
	    			 && !add_business_typeED.getText().toString().equals("CONNEKT STAFF")
	    			 ){
	    		 add_business_typeED.setError(Html.fromHtml("<font color='red'>STATIC POS / MOBILE POS / FREELANCER</font>")); 
	    	 }
	...
	update_view_all.setOnClickListener(new View.OnClickListener() {
	    ...
	    public void onClick(View v) {
		// TODO Auto-generated method stub
		Intent view_user = new Intent(Add_Update_User_checkin.this,
	...
	if(p_number.length()==0){
		add_mobile.setFocusable(true);
    }else {
    	add_mobile.setFocusable(false);
    }
	//MUHIMU SANA
    ...
    if(phone2.length()==0){
    	add_phone2.setFocusable(true);
    }else {
    	add_phone2.setFocusable(false);
    }
    ...
    if(gender.length()==0){
    	add_genderED.setFocusable(true);
    }else {
    	add_genderED.setFocusable(false);
    }
    ...
    add_dob.setText(dob);
    if(dob.length()==0){
    	add_dob.setFocusable(true);
    }else{
    	add_dob.setFocusable(false);
    }
    ...
    if(address.length()==0){
    	...
    	add_address.setFocusable(false);
    }
    ...
    if(id_type.length()==0){
    	add_id_typeED.setFocusable(true);
    }else{
    	add_id_typeED.setFocusable(false);
    }
    ...
    if(id_number.length()==0){
    	 add_id_number.setFocusable(true);
    }else{
    	add_id_number.setFocusable(false);
    }
    ...
    if(business_name.length()==0){
    	add_business_name.setFocusable(true);
    }else{
    	add_business_name.setFocusable(false);
    }
   ...
   add_business_type= (Spinner) findViewById(R.id.add_business_type);
    ...
    /*if(business_type.length()==0 && add_business_typeED.getText().toString() != "MOBILE POS" && add_business_typeED.getText().toString() != "STATIC POS"){
    	add_business_typeED.setFocusable(true);
    }else{
    	add_business_typeED.setFocusable(false);
    }*/
