...
public class DatabaseHandler_mobile extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "contactsManager_static";
    ...
    private final ArrayList<Contact_mobile> contact_list = new ArrayList<Contact_mobile>();

    public DatabaseHandler_mobile(Context context) {
    ...
    // Adding new contact
    public void Add_Contact(Contact_mobile contact) {
    ...
    Contact_mobile Get_Contact(int id) {
	...
	Contact_mobile contact = new Contact_mobile(Integer.parseInt(cursor.getString(0)),
		cursor.getString(1), 
		cursor.getString(2), 
		cursor.getString(3),
		cursor.getString(4),
    ...
    public ArrayList<Contact_mobile> Get_Contacts() {
	try {
	    contact_list.clear();
		...
		do {
		    Contact_mobile contact = new Contact_mobile();
		    ...
		    contact.setItems(cursor.getString(11));
		    contact.setRdo_name(cursor.getString(12));
		    contact.setRdo_number(cursor.getString(13));
    ...
    public int Update_Contact(Contact_mobile contact) {
	SQLiteDatabase db = this.getWritableDatabase();
