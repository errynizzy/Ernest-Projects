...
public class PestAddTip extends Activity {
...
@Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pestcontroladdtip);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                try {
        			response = CustomHttpClient.executeHttpPost("http://10.0.2.2/farming/addtip.php",postParameters1);
        			Intent i = new Intent(getApplicationContext(),
        					SuccessAddTip.class);
    				startActivity(i);
    				finish();
	 ...
	 // add items into spinner dynamically
	  ...
	  public void addItemsOnspinnerCrops() {
		...
		list1.add("Ants");
		list1.add("Birds");
		list1.add("Mildew, Mold & Fungus");
		list1.add("Caterpillars");
		list1.add("Earwigs");
		list1.add("Mice");
		list1.add("Whitefly");
		list1.add("Deer");
