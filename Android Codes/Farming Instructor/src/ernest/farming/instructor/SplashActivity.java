...
import android.widget.Toast;
 ...
 public class SplashActivity extends Activity {
    ...
    int delay = 50;                  // Milliseconds of delay in the update loop
    int maxBarValue = 50;           // Maximum value of horizontal progress bar
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        typeBar = 0;
        showDialog(typeBar);
        //Toast.makeText(this, "Loading Farming Instructor...", Toast.LENGTH_LONG).show(); 
     ...
     */
        ...
        protected Dialog onCreateDialog(int id) {
            ...
            case 0:                      // Spinner
                ...
                progDialog.setMessage("Farming Instructor Loading...");
