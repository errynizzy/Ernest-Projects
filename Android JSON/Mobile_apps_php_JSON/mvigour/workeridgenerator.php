<title>ID Generator</title><style type="text/css">
<!--
body {
...
-->
  ...
  <tr>
    <td><img src="snaps/header_index.jpg" width="909" height="237" /></td>
  </tr>
  <tr>
    <td align="center">
	  <p><strong>Please Copy this ID and Paste it to Admin HW Page </strong></p>
	  <p>
	    <?php
...
?>
    ...
    <p>	    <a href="web/workerstable/login.php">Admin HW</a> &nbsp;| <a href="web/service_providers/service_providers.php?operation=insert">Back to Registration Page</a> </p>
    <div align="center">
